...
<Note>
  Longer term, we'd like to implement a custom tabbing solution that doesn't rely on macOS native
  tabs. This would allow us to better integrate with macOS tiling window managers.
</Note>
